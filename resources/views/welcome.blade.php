...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ===== PROJECT COVER (first screen, fits one viewport) ===== */
        .lp-cover {
            position: relative;
            height: 100vh;
            min-height: 620px;
            box-sizing: border-box;
            /* bottom pad clears the absolutely-positioned scroll cue */
            padding: 80px 0 72px;
            background: var(--dark-bg);
            display: flex;
            align-items: center;
        ...
        .lp-cover::before {
            ...
            inset: 0;
            background:
                radial-gradient(circle at 20% 20%, rgba(102, 126, 234, 0.18), transparent 45%),
                radial-gradient(circle at 80% 75%, rgba(118, 75, 162, 0.18), transparent 45%);
            pointer-events: none;
        }
        ...
        .lp-cover-cue:hover { color: #fff; }
        .lp-cover-cue i { animation: lp-cue-bounce 1.8s ease-in-out infinite; }

        @keyframes lp-cue-bounce {
        ...
        @media (max-width: 575.98px) {
            .lp-team-table th,
            .lp-team-table td { padding: 0.55rem 0.5rem; }
        }
    </style>
</head>
...
<body>
    ...
    <!-- PROJECT COVER -->
    <section class="lp-cover">
        <div class="lp-cover-inner">
            <span class="lp-cover-eyebrow"><i class="bi bi-mortarboard-fill"></i> Academic Project</span>

            <h1 class="lp-cover-title">Dev<span class="text-gradient">Doko</span></h1>

            <p class="lp-cover-desc">
                DevDoko is a social networking platform built for developers. It brings the things a
                developer community needs into one place — sharing posts with syntax-highlighted code
                snippets, following other developers, discussion groups, direct messaging, job listings
                with applications, a marketplace, and project showcases. Built with Laravel, MySQL and
                Bootstrap.
            </p>

            <table class="lp-team-table">
                <thead>
                    <tr>
                        <th>Student Name</th>
                ...
                <tbody>
                    @foreach ([
                        ['Narayan Shrestha', '159-7-2-07626-2021'],
                        ['Priyanka Karki',   '159-7-2-07640-2021'],
                        ['Simran Baral',     '159-7-2-07650-2021'],
                        ['Prekshya Rai',     '159-7-2-07638-2021'],
                    ] as [$name, $regNo])
                        <tr>
                            <td>{{ $name }}</td>
                            <td>{{ $regNo }}</td>
        ...
        <a href="#lpHero" class="lp-cover-cue">
